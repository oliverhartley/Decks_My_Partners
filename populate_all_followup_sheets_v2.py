...
for cfg in PARTNER_CONFIGS:
    ...
    csv_file = os.path.join("followup_data", f"{safe_name}_followup_v2.csv")
...
print("\n\n==========================================")
print("ALL 9 PARTNER FOLLOWUP SHEETS UPDATED WITH COLUMN A (PARTNER NAME)!")
print("==========================================")
print(json.dumps(summary_results, indent=2))
with open("followup_summary_v2.json", "w") as f:
