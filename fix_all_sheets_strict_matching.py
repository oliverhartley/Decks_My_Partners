...
for cfg in PARTNER_CONFIGS:
    ...
    print(f"\n==========================================")
    print(f"Applying Strict DRP Correlation for: {pname}")
    print(f"==========================================")
    ...
    # Count workload demand per DRP item strictly
    ...
    for r in wkl_bq_rows:
        ...
        # Specific DRP profiles for this exact matched item
        total_drp_for_wkl = 0
        if matched_drp:
            # Pick the primary exact matched item's profile count
    ...
    print(f"Fixed {pname} Follow_up with exact DRP profile counts!")
...
print("\n==========================================")
print("EXACT MATCHING COMPLETE: DEVAID AND ALL PARTNERS UPDATED ACCURATELY!")
print("==========================================")
