...
os.makedirs("followup_data_v4", exist_ok=True)
summary_results = []
...
for cfg in PARTNER_CONFIGS:
    ...
    print(f"\n==========================================")
    print(f"Processing Uncommitted Tier 2 & 3 for: {pname}")
    print(f"==========================================")
...
print("\n\n==========================================")
print("ALL 9 PARTNER FOLLOWUP SHEETS UPDATED (UNCOMMITTED TIER 2 & 3)!")
print("==========================================")
print(json.dumps(summary_results, indent=2))
with open("followup_summary_v4.json", "w") as f:
