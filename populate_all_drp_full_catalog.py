...
os.makedirs("drp_data_full", exist_ok=True)
all_global_drp_rows = [[
    "Partner Name",
    "Pillar",
    "Solution (Sales Play)",
...
for p in PARTNERS:
    ...
    print(f"\n==========================================")
    print(f"Building Full Catalog DRP for: {pname}")
    print(f"==========================================")
    ...
    csv_file = os.path.join("drp_data_full", f"{safe_name}_drp_full.csv")
    ...
    print(f"Updated {pname} DRP_Status with complete 33-item catalog.")

# Update Global Master Dashboard All_DRP_Status tab
print("\n==========================================")
print("Updating Global Master Dashboard All_DRP_Status with full catalog")
print("==========================================")

global_drp_full_csv = "global_dashboard_data/all_drp_status_full.csv"
with open(global_drp_full_csv, "w", newline="", encoding="utf-8") as f:
    writer = csv.writer(f)
...
subprocess.run([GSHEETS, "mutate", "import-csv", GLOBAL_SSID, global_drp_full_csv, "--sheet", "All_DRP_Status"], capture_output=True)
...
print("\n==========================================")
print("ALL DRP TABS UPDATED WITH FULL CATALOG OF PILLARS AND SOLUTION PLAYS!")
print("==========================================")
